...
log_level = 'INFO'
load_from = 'experiment_saved/CITY2FOGGY_with_Dcls_channel_mixing_spatail_attention/pretrained/CITY2FOGGY.pth'
resume_from = None
workflow = [('train', 100)]
...
work_dir = 'outputs/CITY2FOGGY_with_Dcls_channel_mixing_spatail_attention_TINY_GT_LABEL'
adapter = True
adapter_choose = [
