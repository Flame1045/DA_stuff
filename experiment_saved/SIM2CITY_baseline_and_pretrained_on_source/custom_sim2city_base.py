...
evaluation = dict(interval=6488, metric='bbox', classwise=True, iou_thrs=[0.5])
checkpoint_config = dict(interval=6488, by_epoch=False)
log_config = dict(
    interval=50,
...
runner = dict(type='IterBasedRunner', max_iters=64880)
work_dir = 'outputs/BASE_RES50'
adapter = False
adapter_choose = []
da_head = False
grad_cam = False
