...
log_level = 'INFO'
load_from = 'pretrained/SIM2CITY.pth'
resume_from = None
workflow = [('train', 100)]
...
runner = dict(type='IterBasedRunner', max_iters=27375)
work_dir = 'outputs/BASE_WA_Test86+1'
adapter = True
adapter_choose = [
    'slideatten', 'adapter', 'scalar', 'SAP', 'cls_branches', 'reg_branches',
    'label_embedding', 'rpn_head', 'roi_head', 'bbox_head'
]
da_head = False
grad_cam = False
auto_resume = False
