...
evaluation = dict(interval=1488, metric='bbox', classwise=True, iou_thrs=[0.5])
checkpoint_config = dict(interval=1488, by_epoch=False)
log_config = dict(
    interval=50,
...
runner = dict(type='IterBasedRunner', max_iters=59520)
work_dir = 'outputs/BASE_RES50_C2F__'
adapter = False
adapter_choose = []
da_head = False
grad_cam = False
