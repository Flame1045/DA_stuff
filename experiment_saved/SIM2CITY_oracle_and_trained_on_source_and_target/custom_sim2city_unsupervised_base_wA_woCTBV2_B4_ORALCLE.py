...
evaluation = dict(interval=5475, metric='bbox', classwise=True, iou_thrs=[0.5])
checkpoint_config = dict(interval=5475, by_epoch=False)
log_config = dict(
    interval=50,
...
work_dir = 'outputs/sim2city_ORACLE'
adapter = False
adapter_choose = []
da_head = False
grad_cam = False
