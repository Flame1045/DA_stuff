...
# python3 tools/test.py experiment_saved_future_work/SIM2CITY_with_Dcls_channel_mixing_spatail_attention_TINY_GT_LABEL/custom_sim2city_unsupervised_base_wA_woCTBV2_B4.py experiment_saved_future_work/SIM2CITY_with_Dcls_channel_mixing_spatail_attention_TINY_GT_LABEL/iter_45700.pth --eval bbox
