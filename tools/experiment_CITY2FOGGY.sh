...
# python3 tools/test.py experiment_saved/CITY2FOGGY_with_Dcls_channel_mixing_spatail_attention/custom_city2foggy_unsupervised_base_wA_woCTBV2_B4.py  experiment_saved/CITY2FOGGY_with_Dcls_channel_mixing_spatail_attention/iter_49900.pth --eval bbox
