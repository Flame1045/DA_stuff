...
python3 tools/test.py outputs/CITY2FOGGY_with_Dcls_channel_mixing_spatail_attention_TINY_GT_LABEL/custom_city2foggy_unsupervised_base_wA_woCTBV2_B4.py outputs/CITY2FOGGY_with_Dcls_channel_mixing_spatail_attention_TINY_GT_LABEL/iter_31800.pth --eval bbox 